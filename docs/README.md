...
Use **kebab-case** for Markdown files in this folder: `lowercase-with-hyphens.md`.

- **Hub:** [documentation.md](./documentation.md) — overview, getting started, links into reference.
- **Reference:** [reference/](./reference/) — long-form MCP tools, dashboard API, data directory, CLI, etc.
